...
const SelectTrigger = forwardRef<
  ...
  ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & { isLoading?: boolean }
>(({ className, isLoading, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <>
        {!isLoading && <ChevronDown className='size-4 opacity-50' />}
        {isLoading && <LoadingSpinner className='size-4 opacity-50' />}
      </>
